    ...
    public void run() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (TutteLePosizini.get(i).startsWith(l[i]) && TutteLePosizini.get(i + 1).startsWith(l[i])) { // controllo
                                                                                                          ...
                                                                                                          // stessa
                                                                                                          // lettera
                String num1 = TutteLePosizini.get(i).substring(TutteLePosizini.get(i).length()); // controllo il
                                                                                                 // numero
                // iniziale
                String num2 = TutteLePosizini.get(i + 1).substring(TutteLePosizini.get(i + 1).length()); // controllo
                                                                                                         // il
                                                                                                         // numero
                // finale
        ...
        while (condivisa.getInstance().sockets.get(1).barche != null
            ...
            for (Integer i = 0; i < 50; i++) {
                if (condivisa.getInstance().sockets.get(1).barche.contains(attaccoGiocatore[0])) // se la
                                                                                                 // posizione è
                                                                                                 // contenuta
                                                                                                 // nella
                                                                                                 // stringa
                                                                                                 // delle barche
                {
                    condivisa.getInstance().sockets
                            .get(1).barche = condivisa.getInstance().sockets.get(1).barche
                                    .replaceAll(attaccoGiocatore[0], "");
                    rispostaattacco1 = 1;
            ...
            for (Integer i = 0; i < 50; i++) {
                if (condivisa.getInstance().sockets.get(2).barche.contains(attaccoGiocatore2[0])) // se la
                                                                                                  // posizione
                                                                                                  // è
                                                                                                  // contenuta
                                                                                                  // nella
                ...
                {
                    condivisa.getInstance().sockets
                            .get(2).barche = condivisa.getInstance().sockets.get(2).barche
                                    .replaceAll(attaccoGiocatore2[0], "");
                    rispostaattacco2 = 1;
                    // mandare la risposta al client
